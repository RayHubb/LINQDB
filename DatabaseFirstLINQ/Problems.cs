...
namespace DatabaseFirstLINQ
{
    class Problems
    {
        ...
        private void ProblemThree()
        {
            ...
            var productName = product.Where(p => p.Price > 150).OrderBy(p => p.Name).Select(p => p.Name + " " + p.Price);
        ...
        private void ProblemFour()
        {
            ...
            var product = _context.Products;
            var productsWithAnS = product.Where(p => p.Name.Contains("s")).Select(p => p.Name);
            foreach (var p in productsWithAnS)
            {
                Console.WriteLine(p);
            }
        }
        ...
        private void ProblemFive()
        {
            ...
            var userList = users.Where(u => u.RegistrationDate < dt).Select(u => u.Email + " " + u.RegistrationDate);
        ...
        private void ProblemSix()
        {
            ...
            var userList = users.Where(u => u.RegistrationDate > dt1 && u.RegistrationDate < dt2);
            foreach (var u in userList)
            {
        ...
        private void ProblemNine()
        {
            ...
            var customerCart = _context.ShoppingCarts.Include(c => c.User).Include(c => c.Product).Where(c => c.User.Email == "oda@gmail.com").Select(sc => sc.Product.Price).Sum();
            {
        ...
        private void ProblemFourteen()
        {
            ...
            _context.ShoppingCarts.Add(customerCart);
            _context.SaveChanges();
        }
